...
class VpnListNativeView : FrameLayout, NativeView {
    ...
    override fun createView(nativeAd: NativeAd) {
        removeAllViews()
        mClickView.clear()
        prepareInfo = ATNativePrepareInfo()
        LayoutInflater
            .from(context).inflate(R.layout.layout_vpn_list_ad, this)
    ...
    override fun getPrepareInfo(): ATNativePrepareInfo? {
        return prepareInfo
    }
}