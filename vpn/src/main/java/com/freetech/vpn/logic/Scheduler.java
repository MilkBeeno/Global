...
{
	private final String EXECUTE_JOB = "com.freetech.vpn.android.Scheduler.EXECUTE_JOB";
	...
	private PendingIntent createIntent()
	{
        ...
        intent.setComponent(new ComponentName(mContext, Scheduler.class));
        int flag = Build.VERSION.SDK_INT >= 23 ? FLAG_IMMUTABLE : 0;
